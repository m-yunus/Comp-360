...
const SplitandMatrix = ({ onNext, onBack, currentStep ,setPlandataValues}) => {
  ...
  return (
    <>
      <TopNav
        tabActive={"plan"}
        activeStatus={"parity&Guideline"}
        firstStatusNumber={"4"}
        secondStatusNumber={"5"}
        thirdStatusNumber={"6"}
        firstStatus={"Parity&Guideline"}
        secondStatus={"Split&matrix"}
        thirdStatus={"Paygroups"}
      />
      <div className="cyclewrapper">
        <div className="heading-container mt-[-1rem]">
          <h3>Split Recommendation</h3>
        </div>
        <div className="cyclecontainer mt-[-2rem]">
          <h5>Do you want to enable split recommendations?</h5>
        ...
        <div className="cyclecontainer">
          <h5>What is the calculation for split recommendations:</h5>
        ...
        <div className="heading-container">
          <h3>Matrix Recommendations</h3>
        </div>
        <div className="cyclecontainer mt-[-2rem]">
          <h5>Do you want to enable matrix recommendations?</h5>
          <div className="radiobuttons">
            <label>
              <input
                type="radio"
