...
console.log("datareview",data);
  ...
  const handleDownload = async () => {
    try {
      ...
      const res = await axios.get(`${BaseUrl}/api/plan/download-pdf`, {
        headers,
        responseType: "blob", 
      });
  ...
  return (
    <>
      ...
      <div className="cyclewrapper" >
        <div className="cycle" id="pdf-content">
          <div className="headerplan mt-[-1rem]">
            <h3>Merit Compensation 2021-22</h3>

            <div className="iconsheader">
              <FaDownload style={{ color: "grey" }} onClick={handleDownload}   className="cursor-pointer" />
