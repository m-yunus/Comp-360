...
const ParityGuideline = ({
  ...
  const [
    supervisorRecommendationValidation,
    setSupervisorRecommendationValidation,
  ] = useState("yes");
  ...
  return (
    <>
      <TopNav
        tabActive={"plan"}
        activeStatus={"Prorations"}
        firstStatusNumber={"3"}
        secondStatusNumber={"4"}
        thirdStatusNumber={"5"}
        firstStatus={"Prorations"}
        secondStatus={"Parity&Guideline"}
        thirdStatus={"Split&matrix"}
      />
      <div className="cyclewrapper">
        <div className="cycle">
          <div className="heading-container mt-[-1rem]">
            <h3>Parity Measures</h3>
          </div>
          ...
          <div className="ms-[20px]">
            ...
            <div className=" my-5 flex-col">
              ...
              <label className="my-5">
                ...
                />
                Recommendation is allowed above the guidelines with a
                justification
              </label>
            </div>
          </div>
